...
# Plot the mean mixed layer depth 
ax.axhline(mld_mean[1], ls='--', lw=1.5, color='k', alpha=1)

# Plot the range of mixed layer depths (1 standard deviation)
ax.fill_between([0, 45], mld_mean[1] - mld_std[1], mld_mean[1] + mld_std[1], color='k', alpha=0.15)
...
# Plot the mean mixed layer depth 
ax.axhline(mld_mean[2], ls='--', lw=1.5, color='k', alpha=1)

# Plot the range of mixed layer depths (1 standard deviation)
ax.fill_between([0, 45], mld_mean[2] - mld_std[2], mld_mean[2] + mld_std[2], color='k', alpha=0.15)
